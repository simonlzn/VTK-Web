...
launcher_config = {
    ...
    "configuration": {
        ...
        "content": "/home/zshen/src/vtkweb/www",                    # Optional: Directory shared over HTTP
        "proxy_file" : "/home/zshen/src/vtkweb/proxy-mapping.txt",  # Proxy-Mapping file for Apache
        ...
        "log_dir" : "/home/zshen/src/vtkweb/viz-logs",              # Directory for log files
        "upload_dir" : "/home/zshen/src/vtkweb/data",               # If launcher should act as upload server, where to put files
...
class ProcessManager(object):
    ...
    def startProcess(self, session):
        ...
        try:
            proc = subprocess.Popen(session['cmd'])
